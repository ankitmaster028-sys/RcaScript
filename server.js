...
const CONFIG = {
  ...
  DELAY_BETWEEN_TASKS_MS: Number(process.env.RCA_TASK_DELAY_MS || 250),
  DELAY_BETWEEN_QUESTIONS_MS: Number(process.env.RCA_QUESTION_DELAY_MS || 250),
  STATE_VERIFICATION_DELAY_MS: Number(process.env.RCA_STATE_DELAY_MS || 250),
